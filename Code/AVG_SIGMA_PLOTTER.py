...
plt.errorbar(A4_compressed_papier_lijst, A4_avg_h_lijst, yerr=A4_fout_h_lijst, capsize=3, fmt='o', ecolor = "black", label='A4 data and standard deviation', markersize='5')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_h_B_lijst, yerr=A5_fout_h_B_lijst, capsize=3, fmt='o', ecolor = "black", label='A5 data and standard deviation', markersize='5')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
plt.subplot(122)
plt.title('v1/v0 calculation')
plt.errorbar(A4_compressed_papier_lijst, A4_avg_v_lijst, yerr=A4_fout_v_lijst, capsize=3, fmt='o', ecolor = "black", label='A4 data and standard deviation', markersize='5')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_v_B_lijst, yerr=A5_fout_v_B_lijst, capsize=3, fmt='o', ecolor = "black", label='A5 data and standard deviation', markersize='5')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
...
plt.subplot(221)
plt.title('h1/h0 calculation')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_h_O_lijst, yerr=A5_fout_h_O_lijst, capsize=3, fmt='o', ecolor = "black", label='A5', markersize='5', color='darkorange')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
plt.subplot(222)
plt.title('v1/v0 calculation')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_v_O_lijst, yerr=A5_fout_v_O_lijst, capsize=3, fmt='o', ecolor = "black", label='A5', markersize='5', color='darkorange')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
