...
plt.suptitle('A4 and A5 format combined. Restitutioncoefficient, calculated using height difference and using velocity difference. Average of all measurements')
plt.subplot(121)
...
plt.suptitle('A5 format, dropped from half the height of original measurements. Restitutioncoefficient, calculated using height difference and using velocity difference. Average of all measurements')
plt.subplot(221)
plt.title('Height calculation, sqrt(h1/h0)')
