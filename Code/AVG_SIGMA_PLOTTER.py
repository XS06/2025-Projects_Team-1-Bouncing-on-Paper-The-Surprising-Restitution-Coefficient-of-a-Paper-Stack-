...
with A4_CSV as A4:
    ...
    for row in A4:
        ...
        if column[0] != 'A4_papier_lijst':
            ...
            A4_coefficienten_1_h_lijst.append(float(column[1]))
    ...
    for papier in range(0, int(len(A4_papier_lijst) - 2)):
        if A4_papier_lijst[papier] == A4_papier_lijst[papier + 1] == A4_papier_lijst[papier + 2]:
            ...
            A4_sigma_h_lijst.append(float(np.std(A4_temp_h_list)))
            ...
            A4_sigma_v_lijst.append(float(np.std(A4_temp_v_list)))
...
with A5_B_CSV as A5_B:
    ...
    for row in A5_B:
        ...
        if column[0] != 'A5_papier_lijst':
            ...
            A5_coefficienten_1_h_B_lijst.append(float(column[1]))
    ...
    for papier in range(0, int(len(A5_papier_lijst) - 1)):
        if A5_papier_lijst[papier] == A5_papier_lijst[papier + 1]:
            ...
            A5_sigma_h_B_lijst.append(float(np.std(A5_temp_h_B_list)))
            ...
            A5_sigma_v_B_lijst.append(float(np.std(A5_temp_v_B_list)))
...
with A5_O_CSV as A5_O:
    ...
    for row in A5_O:
        ...
        if column[0] != 'A5_papier_lijst':
            A5_papier_lijst.append(int(column[0]))
            A5_coefficienten_1_h_O_lijst.append(float(column[1]))
    ...
    for papier in range(0, int(len(A5_papier_lijst) - 1)):
        if A5_papier_lijst[papier] == A5_papier_lijst[papier + 1]:
            ...
            A5_sigma_h_O_lijst.append(float(np.std(A5_temp_h_O_list)))
            ...
            A5_sigma_v_O_lijst.append(float(np.std(A5_temp_v_O_list)))
...
plt.errorbar(A4_compressed_papier_lijst, A4_avg_h_lijst, yerr=A4_sigma_h_lijst, capsize=3, fmt='o', ecolor = "black", label='A4 data and standard deviation', markersize='5')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_h_B_lijst, yerr=A5_sigma_h_B_lijst, capsize=3, fmt='o', ecolor = "black", label='A5 data and standard deviation', markersize='5')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
plt.subplot(122)
plt.title('v1/v0 calculation')
plt.errorbar(A4_compressed_papier_lijst, A4_avg_v_lijst, yerr=A4_sigma_v_lijst, capsize=3, fmt='o', ecolor = "black", label='A4 data and standard deviation', markersize='5')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_v_B_lijst, yerr=A5_sigma_v_B_lijst, capsize=3, fmt='o', ecolor = "black", label='A5 data and standard deviation', markersize='5')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
...
plt.subplot(221)
plt.title('h1/h0 calculation')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_h_O_lijst, yerr=A5_sigma_h_O_lijst, capsize=3, fmt='o', ecolor = "black", label='A5', markersize='5', color='darkorange')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
plt.subplot(222)
plt.title('v1/v0 calculation')
plt.errorbar(A5_compressed_papier_lijst, A5_avg_v_O_lijst, yerr=A5_sigma_v_O_lijst, capsize=3, fmt='o', ecolor = "black", label='A5', markersize='5', color='darkorange')
plt.xlabel('# of paper pages (amount)')
plt.ylabel('Restitutioncoefficient (ratio)')
plt.legend()
